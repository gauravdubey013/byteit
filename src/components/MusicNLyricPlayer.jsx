...
import { musicNlyrics } from "@/app/Karaoke/[music]/musicData";
import { useEffect, useState } from "react";
import "regenerator-runtime/runtime";

const MusicNLyricPlayer = (props) => {
  ...
  return (
    <div className="text-xl flex flex-col gap-4 items-center justify-center">
      ...
      >
        <source src={props.setAudio} type="audio/mpeg" />
      </audio>
...
export default MusicNLyricPlayer;

MusicNLyricPlayer.defaultProps = {
  setAudio: musicNlyrics.theGoodPart.audio,
  setLyric: musicNlyrics.theGoodPart.lyric,
};
